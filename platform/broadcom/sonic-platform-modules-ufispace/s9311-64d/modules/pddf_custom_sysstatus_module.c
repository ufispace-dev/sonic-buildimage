...
PDDF_DATA_ATTR(cpld1_write_protect , S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(cpld2_write_protect , S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(cpld3_write_protect , S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
...
static struct attribute *sysstatus_data_attributes[] = {
    ...
    &attr_cpld1_write_protect.dev_attr.attr,
    &attr_cpld2_write_protect.dev_attr.attr,
    &attr_cpld3_write_protect.dev_attr.attr,
    NULL
};
