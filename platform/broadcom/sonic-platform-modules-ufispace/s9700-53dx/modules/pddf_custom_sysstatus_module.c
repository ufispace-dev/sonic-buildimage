...
PDDF_DATA_ATTR(cpld4_version, S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(cpld5_version, S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(cpld1_interrupt,   S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(cpld1_interrupt_2, S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(cpld2_interrupt,   S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(cpld3_interrupt,   S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(cpld4_interrupt,   S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(cpld5_interrupt,   S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(gbox_intr_0,       S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(gbox_intr_1,       S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(retimer_intr,      S_IRUGO, show_sysstatus_data, NULL, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(retimer_reset, S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(mac_reset,     S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(mac_reset_2,   S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
...
PDDF_DATA_ATTR(qsfpdd_led_0,  S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(qsfpdd_led_1,  S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(qsfpdd_led_2,  S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(qsfpdd_led_3,  S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(qsfpdd_led_4,  S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(qsfpdd_led_5,  S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(qsfpdd_led_6,  S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(sfp_port_status, S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
PDDF_DATA_ATTR(sfp_port_config, S_IWUSR|S_IRUGO, show_sysstatus_data, store_sysstatus_data, PDDF_UCHAR, sizeof(u8), NULL, NULL);
...
static struct attribute *sysstatus_data_attributes[] = {
    ...
    &attr_cpld1_interrupt.dev_attr.attr,
    &attr_cpld1_interrupt_2.dev_attr.attr,
    &attr_cpld2_interrupt.dev_attr.attr,
    &attr_cpld3_interrupt.dev_attr.attr,
    &attr_cpld4_interrupt.dev_attr.attr,
    &attr_cpld5_interrupt.dev_attr.attr,
    &attr_gbox_intr_0.dev_attr.attr,
    &attr_gbox_intr_1.dev_attr.attr,
    &attr_retimer_intr.dev_attr.attr,
    &attr_retimer_reset.dev_attr.attr,
    &attr_mac_reset.dev_attr.attr,
    &attr_mac_reset_2.dev_attr.attr,
    &attr_psu_status.dev_attr.attr,
    &attr_system_led_0.dev_attr.attr,
    &attr_system_led_1.dev_attr.attr,
    &attr_qsfpdd_led_0.dev_attr.attr,
    &attr_qsfpdd_led_1.dev_attr.attr,
    &attr_qsfpdd_led_2.dev_attr.attr,
    &attr_qsfpdd_led_3.dev_attr.attr,
    &attr_qsfpdd_led_4.dev_attr.attr,
    &attr_qsfpdd_led_5.dev_attr.attr,
    &attr_qsfpdd_led_6.dev_attr.attr,
    &attr_sfp_port_status.dev_attr.attr,
    &attr_sfp_port_config.dev_attr.attr,
    NULL
};
